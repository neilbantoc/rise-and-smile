...
public class AlarmActivityPresenter implements SleepyFaceListener {
    ...
    private static final long AWAKE_ANIMATION_DURATION = 30 * 1000; // number of seconds the user must stay awake
    private static final long VOLUME_ANIMATION_DURATION = (long) (5f * 1000); // how long the volume animates from ringing to silent
